...
import {
    FaDollarSign, FaCalendarAlt, FaRegCommentDots, FaWallet,
} from "react-icons/fa";
import { listCategoriesAPI } from "../../services/category/categoryServices";
import { useMutation, useQuery } from "@tanstack/react-query";
import { updatedTransactionAPI } from "../../services/transactions/transactionServices";
...
const TransactionUpdate = () => {
    ...
    //!Mutation
    const { mutateAsync, isPending, isError: isAddTransErr, error: tranErr, isSuccess } = useMutation({
        mutationFn: updatedTransactionAPI,
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            mutateAsync(data).then((data) => { window.scrollTo({ top: 0, behavior: 'smooth' }); })
