...
const TransactionList = ({ onFilterChange }) => {
  //Filtering state
  ...
  //Fetching data
  const { data: categoryData, isLoading: categoryLoading, error: catergoryErr } = useQuery({
  ...
  //!Mutation
  const { mutateAsync, isPending, error: deleteError, isSuccess } = useMutation({
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="relative">
          ...
          >
            ...
            <option value="Uncategorizes">Uncategorized</option>
              ...
              >
                ...
                <div className="flex space-x-3">
                  <Link
                    ...
                    }} // Passing category details via state
                  >
                    <button
